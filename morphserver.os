...
Функция ПолучитьЗначения(Знач н, Знач ф, мф, Все = Ложь)
	...
	Пока Истина Цикл
		...
		Если НЕ вн = 0 И (НЕ ф1 = 9 ИЛИ НЕ Все) Тогда // есть вложение
			ПолучитьЗначения(вн, ф + Символ(ф1), мф);
		Иначе
		...
		Для каждого гр Из мСлова Цикл
			...
			Пока Истина Цикл
				...
				Пока Истина Цикл
					...
					Если ф1 = ф ИЛИ ф = 41 Тогда  // найден элемент
						Если ф = 41 Тогда // *
					...
					КонецЕсли;
				КонецЦикла;
				Если н = 0 ИЛИ к > СтрДлина(гр) Тогда
					Прервать;
				КонецЕсли;
			КонецЦикла;
