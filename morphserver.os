	...
	ИначеЕсли Команда = "Грамматики" Тогда
		...
		Для каждого гр Из мсл Цикл
			...
			Если н = Неопределено Тогда
				н = НайтиЗначение(МассивИзСтроки(Символ(2) + мгр[0])); // найти грамматику
			...
			Если НЕ н = 0 Тогда // найдено совпадение по образцу
				...
				Если НЕ гр2 = 0 Тогда
					...
					Для каждого мф Из мр Цикл
						...
						Если н = Неопределено Тогда
							н = НайтиЗначение(МассивИзСтроки(Символ(1) + мгр[2])); // найти связь
						...
						Если НЕ н = 0 Тогда
							...
							Если НЕ нф2 = 0 Тогда
								...
								м.Добавить(2);
								м.Добавить(нф2);
								н = НайтиЗначение(м, н); // позиция нужного значения
