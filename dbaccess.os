...
Функция НайтиЗаголовок(ЗапросДанных) Экспорт
	...
	Перем СвойствоЗначение, ПозицияДанных, УсловияОтбора, Позиция, ЧислоЗаписей, Направление;
	...
	Пока Истина Цикл
		...
		Завершен = НЕ ((ПозицияДанных > 12 И Направление = "Назад") ИЛИ (ПозицияДанных + 4 < Размер И Направление = "Вперед"));
	...
	Если Завершен ИЛИ Позиция = ЧислоЗаписей Тогда
