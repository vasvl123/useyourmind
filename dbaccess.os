...
Функция НайтиЗаголовок(ЗапросДанных) Экспорт
	...
	Перем СвойствоЗначение, ПозицияДанных, УсловияОтбора, ЧислоЗаписей;
	...
	ЗапросДанных.Вставить("ВремяПоиска", ТекущаяДата() - ВремяНачало);
	ЗапросДанных.Вставить("ЗаписейПрочитано", ЗаписейПрочитано);

	ЗапросДанных.Вставить("ПозицияДанных", ПозицияДанных);

	Если НЕ Число(ПозицияДанных) > 12 ИЛИ ЧислоЗаписей = 0 Тогда
