...
namespace onesharp
{
    ...
    public class treedb : Onesharp
    {
        ...
        public int СвойствоСтроки(int н, int знСвойство, bool Создать = true)
        {
            ...
            do
            {
                if (нн == 0)
                {
                    ...
                    буф1.ЗаписатьЦелое32(16, н); // указ. строки
