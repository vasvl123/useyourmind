...
namespace onesharp
{
    ...
    public class treedb : Onesharp
    {
        ...
        public int НайтиСтроку(string знСтрока, bool Создать = false)
        {
            ...
            foreach (long ан in атр)
            {
                ...
                do
                {
                    if (нн == 0)
                    {
                        ...
                        буф1.ЗаписатьЦелое32(12, (int)(пдКод / 20)); // след. слово
            ...
            long нз = (long)атр[0]; // последнее слово
            //int и = (int)((long)(атр[атр.Количество() - 1]) / 20); // первое слово

            int и = (int)(пКод / 20); // первый указатель
            ...
            do
            {
                ...
                var ии = буф.ПрочитатьЦелое32(12);
                //var нн = буф.ПрочитатьЦелое32(16);
        ...
        public string ПрочитатьСтроку(int н)
        {
            ...
            do
            {
                ...
                var нс = буф.ПрочитатьЦелое32(16) * 20;
                if (нс == 0) break;
                нз = нс;
