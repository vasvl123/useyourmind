...
namespace onesharp
{
    ...
    public class treedb : Onesharp
    {
        ...
        public Массив ПолучитьСвойства(int н)
        {
            ...
            while (true)
            {
                м.Добавить(Новый.Структура("Тип, Имя, Поз", "С", ПрочитатьСтроку(у._Имя), у._Имя));
        ...
        public Массив ПолучитьСлова(int нн, int н, string с = "", Массив м = null)
        {
            ...
            if (у._Имя == нн)
            {
                if (у._Атрибут != 0) 
                    ...
                    м.Добавить(Новый.Структура("Тип, Имя, Поз", "Ф", ПрочитатьСтроку(у._Код), у._Код));

            }
            else
                м.Добавить(Новый.Структура("Тип, Имя, Поз", "П", ПрочитатьСтроку(у._Значение) + " - " + ПрочитатьСтроку(у._Имя), у._Код));
