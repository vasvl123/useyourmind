        ...
        public _Узел НайтиСтроку(string знСтрока, bool Создать = false)
        {
            ...
            foreach (var Слово in мСтр)
            {
                ...
                for (var н = 1; н <= Стр.Длина(Слово); н++)
                {
                    ...
                    while (!(дУзел._Имя == с && дУзел._Значение == дКод))
                    {
                        int нн;
                        ...
                        if (нн == 0)
                        {
                            ...
                            var нУзел = new _Узел();
                            нУзел._Имя = с;
                            нУзел._Значение = дКод;
                            нн = ЗаписатьУзел(ref нУзел);
                            if (дУзел._Имя > с)
                                дУзел._Дочерний = нн;
                            else
                                дУзел._Соседний = нн;
                ...
                if (дУзел._Атрибут == 0)
                {
                    ...
                    аУзел = new _Узел();
                    аУзел._Значение = дУзел._Код;
                    аУзел._Атрибут = пКод;
                    дУзел._Атрибут = ЗаписатьУзел(ref аУзел);
                    ЗаписатьУзел(ref дУзел);
                }
                else
                    аУзел = ПрочитатьУзел(дУзел._Атрибут);
