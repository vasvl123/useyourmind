...
namespace onesharp
{
    ...
    public class treedb : Onesharp
    {
        ...
        public Массив ПолучитьСлова(int нн, int н, string с = "", Массив м = null)
        {
            var у = ПрочитатьУзел(н);
            ...
            if (у._Имя != нн && у._Атрибут != 0)
            {
                м.Добавить(Новый.Структура("Тип, Имя, Поз", "С", ПрочитатьСтроку(у._Атрибут), у._Атрибут));
            }
        ...
        public int СвойствоСтроки(int н, int знСвойство, bool Создать = true)
        {
            ...
            do
            {
                if (нн == 0)
                {
                    ...
                    буф1.ЗаписатьЦелое32(12, знСвойство); // тек слово.
                    буф1.ЗаписатьЦелое32(16, н); // след. указатель
        ...
        public string ПрочитатьСтроку(int н)
        {
            ...
            do
            {
                ...
                var нс = буф.ПрочитатьЦелое32(12) * 20;
