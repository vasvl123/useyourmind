        ...
        { 
            ...
            if (н != 0)
            {
                ...
                do
                {
                    ...
                    нс = буф.ПрочитатьЦелое32(12);
                    if (нс == 0) break; // свойство в последнем слове
                ...
                do
                {
                    ...
                    if (и == 0)
                        нз = буф.ПрочитатьЦелое32(8) * 20; // свойства в последнем атрибуте
                    else if (и > н)
                    ...
                    if (нз == 0)
                    {
                        if (Создать)
                        {
                            ...
                            if (и == 0)
                                буф.ЗаписатьЦелое32(8, (int)(нз / 20));
                            else if (и > н)
