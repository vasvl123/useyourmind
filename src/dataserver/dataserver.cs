        ...
        public ДвоичныеДанные УзелВДвоичныеДанные(object знСтруктура)
        {
            ...
            if (знСтруктура != Неопределено)
            {
                foreach (object Элемент in знСтруктура as IEnumerable<object>)
                {
                    ...
                    if (Значение is Узел)
                    {
                        if (Ключ == "Родитель" || Ключ == "Старший")
                        {
                            дЗначение = ПолучитьДвоичныеДанныеИзСтроки(((Узел)Значение).Код);
                        }
                        else
                        {
                            Ключ = "*" + Ключ;                        
                                ...
                                foreach (Задача стрЗадача in мЗадачи)
                                {
                                    if (стрЗадача.Запрос.Команда == "ПолучитьДанные")
                                    {
                                        if (стрЗадача.Данные == Данные)
                                        {
                                            ...
                                            if (дДанные == null) дДанные = УзелВДвоичныеДанные(Узел);
        ...
        bool? ВыполнитьЗадачу(Задача структЗадача)
        {
            ...
            if (Команда == "ПолучитьУзел")
            {
                ...
                if (_Данные != null)
                {
                    ...
                    структЗадача.Результат = Новый.Структура("Данные", УзелВДвоичныеДанные(_Данные.ПолучитьУзел(Запрос["УзелКод"])));
                    return Истина;
                }
            ...
            if (Команда == "СохранитьУзел")
            {
                ...
                if (_Данные != null)
                {
                    _Данные.СохранитьУзел(_Данные.СтруктуруВУзел(Запрос["Узел"] as Структура));
                    ...
                    { // чтение данных из файла
                        try
                        {
                            if (ИстДанных == Субъект || ИстДанных == "" || ИстДанных == "public")
                            {
                                ...
                                структЗадача.Результат = Новый.Структура("Данные, ИстДанных, ИмяДанных", УзелВДвоичныеДанные(_Данные.Корень), _Данные.ИстДанных, _Данные.ИмяДанных);
                                return Истина;
