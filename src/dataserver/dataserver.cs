        ...
        bool? ВыполнитьЗадачу(Задача структЗадача)
        {
            ...
            if (Команда == "СохранитьУзел")
            {
                ...
                if (_Данные != null)
                {
                    ...
                    var стрУзел = ДвоичныеДанныеВСтруктуру(Запрос["дДанные"] as ДвоичныеДанные) as Структура;
                    var Узел = _Данные.СтруктуруВУзел(стрУзел);
                    ...
                    { // чтение данных из файла
                        try
                        {
                            if (ИстДанных == Субъект || ИстДанных == "" || ИстДанных == "public")
                            {
                                ...
                                _Данные.Корень.Вставить("_Код", "1");
