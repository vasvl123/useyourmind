    ...
    class dataserver : useyourmind, Ishowdata
    {
        ...
        bool ОбработатьДанные(Задача структЗадача = null)
        {
            ...
            if (структЗадача != null)
            {
                ...
                var Данные = ПолучитьДанные<treedata>(ИстДанных, ИмяДанных) as treedata;
                ...
                { // чтение данных из файла
                    try
                    {
                        if ((ИстДанных == Субъект || ИстДанных == "" || ИстДанных == "public"))
                        {
                            ...
                            if (_Данные != null)
                            { // у себя
                                структЗадача.Вставить("Результат", Структура.Новый("Данные", УзелВДвоичныеДанные(_Данные.Корень)));
