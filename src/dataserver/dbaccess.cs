...
namespace onesharp
{
    class dbaccess : Onesharp 
    {
        ...
        public Структура ПолучитьЗаголовки()
        {
            ...
            while (ПозицияДанных > 12)
            {
                ...
                { // Заголовок
                    ...
                    Результат.Вставить("З" + Индекс, Функции.ДвоичныеДанныеВСтруктуру(дЗаголовок));
                    Индекс = Индекс + 1;
                }
        ...
        public object НайтиЗаголовок(Структура ЗапросДанных)
        {
            ...
            if (_ПозицияДанных != Неопределено && _ПозицияДанных != "")
            {
            ...
            while (Истина)
            {
                ...
                { // Заголовок
                    ...
                    var Заголовок = Функции.ДвоичныеДанныеВСтруктуру(дЗаголовок) as Структура;
                    ...
                    if (!(УсловияОтбора == Неопределено))
                    {
                        ...
                        foreach (КлючИЗначение элУсловия in УсловияОтбора as Структура)
                        {
                            ...
                            {
                                ТолькоОдин = зн.с.Значение;
                            }
                            else if (Заголовок.Свойство((string)элУсловия.Ключ, out СвойствоЗначение))
                            {
                                if (зн.с.Сравнение == "Равно")
                                {
                                    ЗаголовокНайден = ((string)СвойствоЗначение == зн.с.Значение);
                                }
                                if (!(ЗаголовокНайден))
                                {
                                    break;
            ...
            if ((bool)Завершен)
            {
                ...
                {
                    if (ЗапросДанных.с.Обновление == "Авто")
                    {
        ...
        public long ДобавитьДанные(Структура Заголовок, ДвоичныеДанные дДанные = null)
        {
            ...
            var дЗаголовок = Функции.СтруктуруВДвоичныеДанные(Заголовок);
