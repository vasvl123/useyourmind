    ...
    public class parse : useyourmind
    {
        ...
        public void parse_ruez()
        {
            ...
            while (н < кор.КоличествоСтрок())
            {
                ...
                {
                    var у = тез.ПрочитатьУзел(тез.СвойстваСтроки(тез.НайтиСтроку(эл["name"] as string, Истина), Истина));
                    ...
                    foreach (Структура св1 in эл["rels"] as Массив)
                    {
                        ...
                        {
                            while (у._Соседний != 0)
                                у = тез.ПрочитатьУзел(у._Соседний);

                            ну = new _Узел();
                            у._Соседний = тез.ЗаписатьУзел(ref ну);
                    ...
                    foreach (string св1 in эл["words"] as Массив)
                    {
                        ...
                        у = тез.ПрочитатьУзел(тез.СвойстваСтроки(тез.НайтиСтроку(св1, Истина)));
        ...
        public void test()
        {
            ...
            var у = сл.ПрочитатьУзел(сл.СвойстваСтроки(сл.НайтиСтроку("мама, мыла раму?", Истина), Истина));
            Сообщить(у._Код);
