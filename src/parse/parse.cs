    ...
    public class parse : useyourmind
    {
        ...
        public void parse_ruez()
        {
            ...
            while (н < кор.КоличествоСтрок())
            {
                ...
                {
                    var свойства = тез.НайтиСтроку("Свойства", Истина);
                    var у = тез.ПрочитатьУзел(тез.СвойствоСтроки(тез.НайтиСтроку(эл["name"] as string, Истина), свойства));
                    var су = тез.ПрочитатьУзел(у._Атрибут);
                    ...
                    foreach (string св1 in эл["words"] as Массив)
                    {
                        ...
                        у = тез.ПрочитатьУзел(тез.СвойствоСтроки(тез.НайтиСтроку(св1, Истина), свойства));
                        су = тез.ПрочитатьУзел(у._Атрибут);
        ...
        public void test()
        {
            ...
            Сообщить(сл.ПрочитатьСтроку(20));
