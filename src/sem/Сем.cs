    ...
    public class Сем : Onesharp
    {
        ...
        public void ОбработатьОтвет(string Действие, pagedata Данные, Узел Свойства, Структура Результат)
        {
            ...
            else if (Действие == "Элемент")
            {
                ...
                Свойства.дс.Номер.Значение = Результат.с.Строка;
        ...
        public string Элемент_Свойства(pagedata Данные, Узел оУзел)
        {
            ...
            var Запрос = Структура.Новый("Библиотека, Данные, Параметры, Свойства, cmd", this, Данные, Структура.Новый("Позиция, База, Действие", Свойства.дс.Позиция.Значение, Свойства.дс.База.Значение, "Элемент"), Свойства, "Морфология");
        ...
        public void Элемент_Модель(pagedata Данные, Узел Свойства, Соответствие Изменения)
        {
            ...
            if (Свойства.дс.Показать.Значение == "Да")
            {
                ...
                {
                    var н = 1;
                    foreach (int зн in Свойства.п.с.Элементы as Массив)
                    {
                        var д = Данные.НовыйСоседний(Свойства, ИмяЗначение("О", "Сем.Элемент"), Истина);
                        д = Данные.НовыйДочерний(д, ИмяЗначение("Свойства."), Истина);
                        Данные.НовыйДочерний(д, ИмяЗначение("Позиция", зн), Истина);
            ...
            if (Свойства.дс.Элемент.Значение == "")
            {
                Свойства.дс.Элемент.Значение = Свойства.дс.Номер.Значение;
            }
        ...
        public void Страница_Модель(pagedata Данные, Узел Свойства, Соответствие Изменения)
        {
            ...
            var см = (Свойства.дс.Показать.Значение == "Нет") ? "&#9655;" : "&#9661;";
            var Вид = Стр.Заменить(ш, ".текст", см);
            Вид = "<div class='btn-group' role='group'>" + Вид + Стр.Заменить(ш, ".текст", Свойства.дс.Номер.Значение) + "</div>";
