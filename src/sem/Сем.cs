...
namespace onesharp.lib
{
    public class Сем : Onesharp
    {
        ...
        public void ОбработатьОтвет(string Действие, treedata Данные, Узел Свойства, Структура Результат)
        {
        ...
        public string Корень_Свойства(treedata Данные, Узел оУзел)
        {
        ...
        public string Элемент_Свойства(treedata Данные, Узел оУзел)
        {
        ...
        public void Элемент_Модель(treedata Данные, Узел Свойства, Соответствие Изменения)
        {
        ...
        public string Страница_Свойства(treedata Данные, Узел оУзел)
        {
        ...
        public void Страница_Модель(treedata Данные, Узел Свойства, Соответствие Изменения)
        {
        ...
        Массив свФормы(treedata Данные, string св)
        {
        ...
        public string Предложение_Свойства(treedata Данные, Узел оУзел)
        {
        ...
        public void Предложение_Модель(treedata Данные, Узел Свойства, Соответствие Изменения)
        {
            var оУзел = Свойства.Родитель;
        ...
        object ТокенВид(treedata Данные, Узел Свойства, Узел дУзел, Массив мУзел = null, Узел рУзел = null)
        {
            var Связи = "";
            var вТокен = Свойства.д.с.вТокен.Значение as Узел;
