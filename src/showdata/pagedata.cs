...
namespace onesharp
{
    class pagedata : Onesharp
    {
        ...
        public void ДобавитьСобытие(Узел Узел, string Событие, object Значение = null)
        {
            ...
            if (!(УзелОбъект == Неопределено))
            {
                ...
                if (!(Свойства == Неопределено))
                {
                    ...
                    {
                        НовоеЗначениеУзла(Свойства.д.с.События, стрСобытие, Истина, Истина);
                    }
                }
            }
        } // ДобавитьСобытие()
        ...
        {
            var Вид = "<script>var p = {id: '" + Узел.с.Код + "', fid: '" + Свойства.д.с.Форма.Код + "'";
        ...
        public object ОбработатьОбъект(Узел Узел, bool Инициализация = false)
        {
            ...
            { // Стандартный вид
                var Вид = ЗначениеСвойства(Свойства.д.с.Вид);
