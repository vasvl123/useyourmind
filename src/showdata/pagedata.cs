...
namespace onesharp
{
    class pagedata : Onesharp
    {
        ...
        public void ОбъектыОбновитьДобавить(Узел оУзел)
        {
            ...
            {
                оУзел.Вставить("Содержимое", Неопределено);
                оУзел.Вставить("Состояние", Неопределено);
        ...
        public object ОбработатьОбъект(Узел Узел, bool Инициализация = false)
        {
            ...
            { // Стандартный вид
                var Вид = ЗначениеСвойства(Свойства.д.Вид);
            ...
            else
            {
                ...
                if (Содержимое == Неопределено)
                {
                    ...
                    {
                        Содержимое = Интерпретировать(Узел.с.Свойства, Неопределено, Ложь);
