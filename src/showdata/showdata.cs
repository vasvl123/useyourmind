    ...
    public class showdata : useyourmind, Ishowdata
    {
        ...
        object ВыполнитьДействия(Задача структЗадача)
        {
            ...
            else if (Действие == "ПолучитьУзел")
            {
                ...
                { // запросить данные
                    var стрЗапрос = Структура.Новый("ИстДанных, ИмяДанных, УзелКод, Команда", Запрос.Данные.ИстДанных, Запрос.Данные.ИмяДанных, Запрос["УзелКод"], "ПолучитьУзел");
                ...
                { // получен ответ дата-сервера
                    ...
                    if (Ответ == "ЕстьУзел")
                    {
                        ...
                        нУзел.Родитель = Запрос.Получить<Узел>("Родитель");
                        нУзел.Старший = Запрос.Получить<Узел>("Старший");
