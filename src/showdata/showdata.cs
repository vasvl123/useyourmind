                    ...
                    if (структЗадача.Данные == null)
                    {
                        ...
                        if (Ответ == "ЗапросВыполняется")
                        {
                            ...
                            if (ТипДанных != "2") // не файл
                            {
                                ...
                                структЗадача.Данные = new pagedata(this, Запрос.ИстДанных, Запрос.ИмяДанных, стрДанные["Код"] as string);
                                ((pagedata)структЗадача.Данные).СтруктуруВУзел(стрДанные);
                            }
                        }
                        else
                        {
