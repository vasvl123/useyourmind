...
namespace onesharp
{
    class showdata : useyourmind
    {
        ...
        object ВыполнитьДействия(Задача структЗадача)
        {
            ...
            {
                if (структЗадача.Результат != Неопределено)
                {
                    var Результат = ПолучитьДвоичныеДанныеИзСтроки(структЗадача.Результат + "<end/>");
        ...
        void ОбработатьСоединения()
        {
            ...
            while (Истина)
            {
                ...
                if (РезультатОбновить != "")
                {
                    ...
                    {
                        if (upddata.Результат == Неопределено)
                        {
                            upddata.Результат = РезультатОбновить;
                            РезультатОбновить = "";
                        }
                    }
                }
