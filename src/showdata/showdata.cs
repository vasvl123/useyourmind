    ...
    class showdata : Onesharp
    {
        ...
        Вкладка НоваяСтруктураВкладка(object Данные, string ТипВкладки, string Заголовок, string Режим, string УзелКод)
        {
            ...
            if (!(ТипВкладки == "prop"))
            {
                ...
                {
                    мВкладки.Вставить(мВкладки.Найти(ТекущаяВкладка) + 1, НоваяВкладка);
                }
                else
                {
        ...
        object ВыполнитьДействия(Задача структЗадача)
        {
            ...
            else if (Действие == Команда["ЗагрузитьHTML"] as string)
            {
                ...
                else
                {
                    ...
                    Данные.ЗагрузитьHTML(дУзел, Массив.Новый(СтруктураHTML), 0);
            ...
            else if (Действие == Команда["ЗначениеУзла"] as string)
            {
                ...
                ТекущееОкно = НоваяСтруктураВкладка(Вкладка.Данные, "win", Данные.ИмяДанных + " Значение " + " " + Узел.Имя + ":" + СтрЭкранироватьРазметку(Данные.УзелСвойство(Узел, "Значение") as string, 20), "view", Узел.Код);
