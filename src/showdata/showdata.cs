...
namespace onesharp
{
    public class showdata : useyourmind, Ishowdata
    {
        ...
        object ПоказатьВкладки()
        {
            ...
            ПараметрыШаблона.Вставить("ПараметрЗаголовокСтраницы", "" + ТекущиеДанные["ЗаголовокСтраницы"]);
        ...
        object ВыполнитьДействия(Задача структЗадача)
        {
            ...
            else if (Действие == "ПолучитьУзел")
            {
                ...
                { // получен ответ дата-сервера
                    ...
                    if (Ответ == "ЕстьУзел")
                    {
                        ...
                        var стрДанные = ДвоичныеДанныеВСтруктуру(дДанные) as Структура;
                        var нУзел = _Данные.СтруктуруВУзел(стрДанные);
                ...
                { // получен ответ дата-сервера
                    if (структЗадача.Данные == null)
                    {
                        ...
                        if (Ответ == "ЕстьДанные")
                        {
                            ...
                            if (ТипДанных != "2") // не файл
                            {
                                ...
                                сДанные.СтруктуруВУзел(стрДанные);
                    ...
                    { // обновление данных
                        ...
                        if (Ответ == "ЕстьДанные")
                        {
                            ...
                            {
                                var стрДанные = ДвоичныеДанныеВСтруктуру(дДанные) as Структура;
                                _Данные.ОбъектыОбновить.Добавить(_Данные.СтруктуруВУзел(стрДанные));
                            }
            ...
            else if (Действие == Команда["ЗначениеУзла"] as string)
            {
                ...
                ТекущиеДанные = НоваяСтруктураВкладка(Вкладка.Данные, "win", Данные.ИмяДанных + " Значение " + " " + Узел.Имя + " : " + СтрЭкранироватьРазметку(Узел.Значение as string, 20), "view", Узел.Код);
