                    ...
                    while (!(ток1 == Неопределено))
                    {
                        ...
                        if (!(ток1Формы == null))
                        {
                            ...
                            { // варианты форм
                                ...
                                нФормы.Вставить((string)нвар.с.токнач);
                                мУзел1.Добавить(нвар);
                                фУзел1 = фУзел1.Соседний;
                            }
                            Слова.Добавить(Новый.Структура("сл, ф", ВРег(ток1.Имя), мУзел1));

                            ток1.п.Вставить("нф", нФормы); // начальные формы
                        }
                                    ...
                                    foreach (Структура св in мсв)
                                    {
                                        ...
                                        { // корректная связь
                                            ...
                                            if (корр)
                                            {
                                                ...
                                                ток1.п.Вставить("свкод", нп.Код);
                                                ток1.п.Вставить("свимя", нп.Имя);
