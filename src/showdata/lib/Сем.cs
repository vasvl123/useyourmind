                    ...
                    if (тСобытие == "ПриНажатии")
                    {
                        ...
                        if (!(ЗначениеКнопка is null))
                        {
                                    ...
                                    { // И НЕ вТокен.Значение = "" И НЕ сУзел.Значение = "" Тогда
                                      // добавить связь
                                        ...
                                        { // варианты форм
                                            ...
                                            {
                                                мУзел1.Добавить(Новый.Структура("ток1гр, ток1нач", фУзел1.Значение, (фУзел1.Атрибут == Неопределено) ? фУзел1.Имя : фУзел1.Атрибут.Имя));
                                            }
                                        ...
                                        { // варианты форм
                                            if (сУзел.Значение as string == "")
                                            {
                                                ...
                                                { // не одна форма
                                                    мУзел2.Добавить(Новый.Структура("ток2гр, ток2нач", фУзел2.Значение, (фУзел2.Атрибут == Неопределено) ? фУзел2.Имя : фУзел2.Атрибут.Имя));
                                                }
                                            }
                            ...
                            else if (ЗначениеКнопка == "conf" || ЗначениеКнопка == "excl" || ЗначениеКнопка == "del" || ЗначениеКнопка == "delgr")
                            {
                                ...
                                var св = Новый.Структура("ток1, ток2, свимя, б", сУзел.п.ток1ф, сУзел.п.ток2ф, ВРег(сУзел.Имя), б);
