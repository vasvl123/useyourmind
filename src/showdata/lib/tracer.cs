    ...
    class tracer : Onesharp
    {
            ...
            if (!(УзелСвойство(оУзел, "Обновить") as bool? == Ложь))
            {
                ...
                if (Свойства.д.Новая.Значение == "Да")
                {
                    ...
                    if (Ид.Количество() != 0)
                    {
                        ...
                        if (Лев(Свойства.д.Имя.Значение, 1) == "b")
                        {
                            свп.д.Имя.Значение = Свойства.д.Имя.Значение;
                            свп.д.Ид.Значение = Ид;
                            свп.д.Ширина.Значение = 320;
                            свп.д.Высота.Значение = 320;
                            свп.д.Масштаб.Значение = 1;
                        ...
                        else
                        {
                            ...
                            свп.д.Имя.Значение = "b" + Свойства.д.Имя.Значение;
                            свп.д.Ид.Значение = Ид;
        ...
        public void Пиксель_Модель(pagedata Данные, Узел Свойства, Соответствие Изменения)
        {
            ...
            if (!(УзелСвойство(оУзел, "Обновить") as bool? == Ложь))
            {
                ...
                int _мшб = Свойства.д.Мшб.Значение;
                ...
                else if (Дальше != "")
                {
                    if (_шир > 32 && _шир%2 == 0 && _выс%2 == 0)
                    {
                        ...
                        Свойства.д.Вид.Значение = "<div style='width:" + _шир*_мшб + "px; height:" + _выс*_мшб + "px; background-color: " + цвзн + "'></div>";
                    }
                    else
                    {
                        Свойства.д.Вид.Значение = Рендер(Кадр, Кадр.Высота, Кадр.Ширина, _верт, _гор, _выс, _шир, _мшб);
                        Дальше = "";
                    }
        ...
        public void Кадр_Модель(pagedata Данные, Узел Свойства, Соответствие Изменения)
        {
            ...
            if (Изменения.Получить(Свойства.д.События) as bool? == Истина)
            {
                ...
                if (!(дУзел is null))
                {
                    ...
                    if (тСобытие == "ПриНажатии")
                    {
                        ...
                        if (!(ЗначениеКнопка is null))
                        {
                            if (ЗначениеКнопка == "sel")
                            {
                                ...
                                var Параметры = Новый.Структура("Данные, Свойства, data, templ, cmd", Данные, Свойства, "" + Свойства.д.Имя.Значение, "tracer", "newtab");
                    ...
                    { 
                        ...
                        {
                            _Свойства.д.Имя.Значение = Свойства.д.Имя.Значение;
            ...
            if (!(УзелСвойство(оУзел, "Обновить") as bool? == Ложь))
            {
                ...
                if (Свойства.д.Новый.Значение == "Да")
                {
                    ...
                    свп.д.Мшб.Значение = (int)Свойства.д.Масштаб.Значение;
