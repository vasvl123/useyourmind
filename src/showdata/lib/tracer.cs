        ...
        public void Страница_Модель(pagedata Данные, Узел Свойства, Соответствие Изменения)
        {
            ...
            if (!(УзелСвойство(оУзел, "Обновить") as bool? == Ложь))
            {
                ...
                if (Свойства.д.Новая.Значение == "Да")
                {
                    ...
                    var Кадр = Свойства.д.Кадр.Значение;
                    if (ЗначениеЗаполнено(Кадр))
                    {
                        var в = Рендер(Кадр, 196, 196, 0, 0, 196, 196);
                        Данные.НовыйДочерний(оУзел, ИмяЗначение("div", в), Истина, Истина);
                    }
                ...
                if (!(дУзел is null))
                {
                    ...
                    { 
                        ...
                        if (!ЗначениеЗаполнено(_Свойства.д.Ид.Значение)) 
                        {
                            ...
                            _Свойства.д.Кадр.Значение = Свойства.д.Кадр.Значение;
                        }
                        else
                        {
