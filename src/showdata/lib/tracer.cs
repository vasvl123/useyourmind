    ...
    class tracer : Onesharp
    {
        ...
        string Рендер(Кадр Кадр, int Высота, int Ширина, int _верт, int _гор, int _выс, int _шир)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                рез = "<img src='data:image/png;base64," + Convert.ToBase64String(ms.GetBuffer()) + "' style='width:" + _шир*2 + "px;height:" + _выс*2 + "px;'>";
            }
