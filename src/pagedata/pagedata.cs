    ...
    public class pagedata : Onesharp
    {
        ...
        public object ОбработатьОбъект(Узел Узел, bool Инициализация = false)
        {
            ...
            { // инициализация
                ...
                if (Узел == Корень)
                {
                    Узел уВерсии = Свойства.д("Версии").Дочерний;
            ...
            { // Стандартный вид
                var Вид = Свойства.д("Вид").Значение as Структура;
                Состояние = "<obj id='_" + Узел.Код + "'>" + Вид + Свойства.д("Описание").Значение + "</obj>";
            }
            else
            {
                ...
                Состояние = "<obj id='_" + Узел.Код + "'>" + Свойства.д("Описание").Значение + Содержимое + "</obj>";
            }
            ...
            while (!(СледУзел == Неопределено))
            {
                ...
                { // значение переменной объекта
                    ...
                    while (!(сУзел == Неопределено))
                    {
                        ...
                        {
                            Состояние = сУзел.Родитель.Значение as string;
        ...
        bool ЭтоАтрибут(Узел Узел)
        {
            return (Узел.Родитель.Атрибут == Узел || ЭтоАтрибут(Узел.Старший) && Узел.Старший.Соседний == Узел);
        }
