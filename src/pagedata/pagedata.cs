...
namespace onesharp
{
    public class pagedata : Onesharp
    {
        ...
        Узел СтруктуруВУзел(Структура стрУзел)
        {
            ...
            if (Узел == null)
            {
                ...
                if (!(Узел["Дочерний"] is null)) стрУзел["Дочерний"] = СтруктуруВУзел(стрУзел["Дочерний"] as Структура);
                if (!(Узел["Соседний"] is null)) стрУзел["Соседний"] = СтруктуруВУзел(стрУзел["Соседний"] as Структура);
            }

            return Узел;
        }

        public pagedata(Ishowdata обПроцесс, Структура стрКорень = null, string знИстДанных = "", string знИмяДанных = "") : base("pagedata")
        {
            ...
            if (стрКорень == null)
            {
                ...
                Корень = СтруктуруВУзел(стрКорень);
