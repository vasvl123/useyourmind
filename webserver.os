...
Процедура ЛогСообщить(Сообщение, Тип = 0)
	...
	Если НЕ Параметры = Неопределено Тогда
		ПередатьДанные(Параметры.Хост, Параметры.ПортД, Новый Структура("БазаДанных, Заголовок, Команда", "web", Новый Структура("Тип, Сообщение", Тип, Сообщение), "ЗаписатьЗаголовок"));
	КонецЕсли;
КонецПроцедуры
