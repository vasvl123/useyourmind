...
Процедура ЛогСообщить(Сообщение, Тип = 0)
	...
	Если НЕ Параметры = Неопределено Тогда
		//ПередатьДанные(Параметры.Хост, Параметры.ПортД, Новый Структура("БазаДанных, Заголовок, Команда", "log", Новый Структура("Источник, Тип, Сообщение", "webserver.os", Тип, Сообщение), "ЗаписатьЗаголовок"));
	КонецЕсли;
КонецПроцедуры
