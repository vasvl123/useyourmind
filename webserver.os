...
Процедура ОбработатьДанные(Задача, Записать = Ложь)
	Перем Команда, ИмяДанных;

	Если Задача.ИмяКонтроллера = "showdata" Тогда
		БазаДанных = Задача.ИмяМетода;
		Если НЕ БазаДанных = "" Тогда
			...
			КонецЕсли;
			Запрос.Вставить("БазаДанных", БазаДанных);
				...
				Если Команда = "savedata" И Записать Тогда
					...
					Если НЕ ФайлДанных = Неопределено Тогда
						Если Данные.ОткрытьПотокДанных(Истина) Тогда
							Данные.ДобавитьДанные(Новый Структура("ИмяФайла, ИмяДанных, Режим, Расширение", ФайлДанных, ИмяДанных, Запрос.mode, "s"));
						КонецЕсли;
					КонецЕсли;
				...
				ИначеЕсли НЕ Записать Тогда
					Если Данные.ОткрытьПотокДанных() Тогда
						...
						Если НЕ Заголовок = Неопределено Тогда
							...
							Запрос.Вставить("Режим", Заголовок.Режим);
						КонецЕсли;
					КонецЕсли;
					Если ФайлДанных = "" Тогда
						...
						Запрос.Вставить("Режим", "node");
					КонецЕсли;
					Запрос.Вставить("ИмяДанных", ИмяДанных);
					Запрос.Вставить("ФайлДанных", ФайлДанных);
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
