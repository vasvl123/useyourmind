			...
			Если Задача.ИмяКонтроллера = "" Тогда
				...
				Если Задача.ПараметрыЗапроса.Свойство("cmd", cmd) Тогда
					...
					Если cmd = "auth" ИЛИ cmd = "reg" Тогда
						...
						Сообщить(Задача.ПараметрыЗапроса);
...
Процедура ЛогСообщить(Сообщение)
	...
	ВыполнитьЗапросКСерверуДанных("osdb" + Символы.Таб + "log" + Символы.Таб + "datatype" +  Символы.Таб + "1" + Символы.Таб + "Источник" + Символы.Таб + "webserver.os" + Символы.Таб + "Сообщение" + Символы.Таб + Сообщение);
КонецПроцедуры
