...
Функция ОтобразитьПараметры(Вкладка, Узел)
	...
	Для каждого св Из Узел Цикл
		...
		ПараметрыШаблона.Вставить("ПараметрИмя", ПараметрИмя);
		ПараметрыШаблона.Вставить("ПараметрЗначение", ПараметрЗначение);
		Параметры = Параметры + КнопкаУзел + ПолучитьОбласть("ОбластьИмяЗначение", ПараметрыШаблона);
	...
	Если Представление = Неопределено Тогда
		Если Обновить Тогда
			...
			Если Узел.Свойство("п") Тогда
				Атрибуты = Атрибуты + ОтобразитьПараметры(Вкладка, Узел.п);
			КонецЕсли;
...
Функция ВыполнитьДействия(структЗадача)
	...
	// Если НЕ Действие = Неопределено Тогда
		...
		ИначеЕсли Действие = "ФормыСлов" ИЛИ Действие = "Биграммы" Тогда // запрос к серверу морфологии
