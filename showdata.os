...
Функция ВыполнитьДействия(структЗадача)
	...
	Если НЕ Действие = Неопределено Тогда
		...
		ИначеЕсли Действие.Имя = Команды["СтруктураДанных"] Тогда
			...
			ТекущееОкно = НоваяСтруктураВкладка(Данные, "win", Вкладка.ИмяДанных + " " + Узел.Имя + " : " + Данные.УзелСвойство(Узел, "Значение"), "struct", Вкладка.ИдУзла, Вкладка.БазаДанных, Вкладка.ИмяДанных);
