...
Функция ВыполнитьДействия(структЗадача)
	...
	Если НЕ Действие = Неопределено Тогда
		...
		Если Действие.Имя = Команда["СохранитьДанные"] Тогда
		...
		Если Действие.Имя = Команда["Выполнить"] Тогда
		...
		ИначеЕсли Действие.Имя = Команда["ЗавершитьПроцесс"] Тогда
...
Если АргументыКоманднойСтроки.Количество() Тогда
	...
	Команда.Вставить("Выполнить", "exec");
