...
Функция Интерпретировать(Узел, Вкладка) Экспорт
	...
	Попытка
		Значение = Вкладка.Данные.ИнтерпретироватьЛисп(Узел);
		...
		Если Представление = "" Тогда
			...
			Иначе
				Если НЕ Узел.Имя = "" Тогда
					Если УзлыЛисп.Свойство(Узел.Имя) Тогда
...
Если АргументыКоманднойСтроки.Количество() Тогда
	...
	УзлыЛисп = Новый Структура("Список, Перем, Свойство, Объект, Узел, Функция");
