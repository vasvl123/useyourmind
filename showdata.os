...
Функция ПолучитьДанныеССервера(БазаДанных, ИмяДанных, ПозицияДанных) Экспорт
	...
	Попытка
		...
		Соединение.ОтправитьДвоичныеДанные(ПолучитьДвоичныеДанныеИзСтроки("osdb" + Символы.Таб + БазаДанных + Символы.Таб + "data" + Символы.Таб + ИмяДанных + Символы.Таб + "dataposition" + Символы.Таб + ПозицияДанных));
...
Функция ПередатьДанныеНаСервер(Данные, БазаДанных, ИмяДанных) Экспорт
	...
	Попытка
		Соединение = Новый TCPСоединение(Хост, ПортД);
		Соединение.ОтправитьДвоичныеДанные(ПолучитьДвоичныеДанныеИзСтроки("osdb" + Символы.Таб + БазаДанных + Символы.Таб + "data" + Символы.Таб + ИмяДанных + Символы.Таб + "datatype" + Символы.Таб + "3"));
