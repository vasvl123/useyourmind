...
Функция НоваяВкладка(Параметры)
	...
	структВкладка = Новый Структура("ИдВкладки, Данные, Заголовок, Режим, ИдУзла, БазаДанных, ИмяДанных, ОбновитьУзел, Скролл",
		ТекущаяВкладка,
		Данные,
		ИмяДанных,
		Параметры.Режим,
...
Функция ВыполнитьДействия(структЗадача)
	...
	Если НЕ Действие = Неопределено Тогда
		...
		ИначеЕсли Действие.Имя = "editinnewtab" Тогда
