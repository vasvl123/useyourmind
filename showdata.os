...
Функция ЗапросВыполнитьЗадачу(структЗадача)
	...
	Если структЗадача.Этап = "ВыполнитьЗадачу" Тогда
		...
		Если НЕ структЗадача.Действие = Неопределено Тогда
			...
			ИначеЕсли СформироватьОтвет = "ЕстьРезультат" Тогда
...
Функция ВыполнитьДействия(структЗадача)
	...
	Если НЕ Действие = Неопределено Тогда
		...
		ИначеЕсли Действие = Команда["ПриНажатии"] Тогда
			АтрибутПриНажатии = Данные.НайтиАтрибут(Узел, "А", "ПриНажатии"); // потом убрать
			Если НЕ АтрибутПриНажатии = Неопределено Тогда
				...
				КонецЕсли;
			КонецЕсли;
			СвойствоПриНажатии = Данные.НайтиАтрибут(Узел, "ПриНажатии"); // при нажатии обновляется узел, указанный по ссылке в свойстве
			Если НЕ СвойствоПриНажатии = Неопределено Тогда
				УзелОбновить = Вкладка.Данные.Интерпретировать(Данные.Дочерний(СвойствоПриНажатии));
				Если НЕ УзелОбновить = Неопределено Тогда
					Данные.УзелУстановитьЗначение(УзелОбновить, "" + ТекущаяДата());
				КонецЕсли;
			КонецЕсли;
