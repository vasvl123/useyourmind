...
Функция ПолучитьДанные(структЗадача)
	...
	ИначеЕсли Данные = Неопределено Тогда
		ЗадачаПараметры = Новый Структура("БазаДанных, ИстДанных, ИмяДанных, ПозицияДанных, ИмяШаблона, cmd", БазаДанных, зИстДанных, ИмяДанных, ПозицияДанных, ИмяШаблона, "ПолучитьДанные");
