...
Функция НоваяБаза(Параметры)
	БазаДанных = "" + УзелСвойство(Параметры, "osdb");
	Если НЕ "" + БазаДанных = "" Тогда
		Соединение = Неопределено;
		ПередатьСтроку(Соединение, "osdb" + Символы.Таб + БазаДанных);
		Попытка
...
Функция ВыполнитьДействия(структЗадача)
	...
	Если НЕ Действие = Неопределено Тогда
		...
		Если Действие.Имя = Команда["НоваяБаза"] Тогда
			ТекущиеДанные = НоваяБаза(Запрос);
			Возврат Истина;
		КонецЕсли;
		...
		Если Действие.Имя = Команда["ОбновитьЗначение"] Тогда
		...
		ИначеЕсли Действие.Имя = Команда["Выполнить"] Тогда
...
Если АргументыКоманднойСтроки.Количество() Тогда
	...
	Команда.Вставить("НоваяБаза", "newbase");
	...
	Команда.Вставить("ОбновитьЗначение", "updvalue");
