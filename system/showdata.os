...
Функция ЗапросВыполнитьЗадачу(структЗадача)
	...
	Если структЗадача.Этап = "ВыполнитьЗадачу" Тогда
		...
		Иначе
			...
			КонецЕсли;
			структЗадача.Этап = "ОбработатьКоманду";
		КонецЕсли;
	КонецЕсли;

	Если структЗадача.Этап = "ОбработатьКоманду" Тогда
		Если Запрос.Свойство("cmd") Тогда
			ОбработатьКоманду(Данные, Запрос);
		КонецЕсли;
...
Функция ОбработатьКоманду(Данные, Запрос, КодУзла = Неопределено) Экспорт
...
Попытка
	...
	Пока Истина Цикл
		...
		Попытка
			...
			структЗадача = Новый Структура("Тип, Этап, Запрос, Соединение, Результат", "Запрос", "ВыполнитьЗадачу", Запрос, Соединение);
		Исключение
