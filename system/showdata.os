...
Функция ОбновитьСостояние(Узел, СостояниеИмя = Неопределено)
	...
	ИначеЕсли СостояниеИмя = "ТребуетсяЗакрыть" ИЛИ СостояниеИмя = Неопределено Тогда
		...
		Если ТребуетсяЗакрыть = Истина Тогда
			...
			РедактируетсяИмя = УзелСостояние(Узел, "УзелРедактируется");
			РедактируетсяЗначение = УзелСостояние(Узел, "УзелРедактируется");
	...
	ИначеЕсли СостояниеИмя = "УзелРедактируется" ИЛИ СостояниеИмя = Неопределено Тогда
	ИначеЕсли СостояниеИмя = "РедактируетсяИмя" ИЛИ СостояниеИмя = Неопределено Тогда
	ИначеЕсли СостояниеИмя = "РедактируетсяЗначение" ИЛИ СостояниеИмя = Неопределено Тогда
	КонецЕсли;
