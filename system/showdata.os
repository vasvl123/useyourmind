...
Функция ПоказатьСтруктуруУзла(Вкладка, КодУзла, ПервыйВызов = Истина) Экспорт
	...
	УзелСостояниеЗначение(Узел, "ПоказатьУзел", Ложь);
...
Функция ОбработатьКоманду(структЗадача) Экспорт
	...
	ИначеЕсли Запрос.cmd = "preview" Тогда
		структЗадача.Действие = Новый Структура("Имя, Узел, Результат", "УзелПросмотр", Узел);
...
Функция УзелСостояниеЗначение(Узел, СостояниеИмя, СостояниеЗначение, Событие = Истина) Экспорт
	Если НЕ Узел = Неопределено Тогда
		...
		// Если НЕ СостояниеИмя = "ПоказатьУзел" Тогда
		// 	Если НЕ СостояниеИмя = "Представление" Тогда
		// 		Узел.Состояние.Вставить("Представление", "");
		// 	КонецЕсли;
		// КонецЕсли;
		Если Событие Тогда
...
Функция ОбновитьСостояние(Данные, Узел, Состояние, Значение)
	...
	ИначеЕсли Состояние = "УзелПросмотр" И Значение = Ложь Тогда
		// ОбновитьСостояние(Данные, Узел, "ПоказатьУзел", Истина);
	...
	ИначеЕсли Состояние = "НовоеЗначениеУзла" Тогда
		...
		// ИначеЕсли Состояние = "ПоказатьУзел" И Значение = Истина Тогда
		// 	ОбновитьСостояние(Данные, Данные.Родитель(Узел), "ПоказатьУзел", Истина);
	...
	// ИначеЕсли Состояние = "ПоказатьУзел" И Значение = Ложь Тогда
	// 	Результат = УзелСостояние(Узел, "ПоказатьУзел");
...
Функция НайтиПоказатьУзел(Данные)
	Для каждого элУзел Из Данные.Узлы Цикл
		...
		Если УзелСостояние(Узел, "ПоказатьУзел") = Истина Тогда
			Если ОбновитьСостояние(Данные, Узел, "ПоказатьУзел", Ложь) = Истина Тогда
				Возврат Узел;
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
...
Функция ВыполнитьДействия(структЗадача)
	...
	Если НЕ Действие = Неопределено Тогда
		...
		Если Действие.Имя = "НоваяВкладка" Тогда
			...
			УзелСостояниеЗначение(Узел, "ПоказатьУзел", Истина);
