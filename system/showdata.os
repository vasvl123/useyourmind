...
Функция НачальнаяСтраница()
	...
	Ответ = Ответ + Шаблон.ПолучитьОбласть("ОбластьДанные", Новый Структура("ПараметрИдПроцесса, ПараметрРежим, ПараметрДанные, ПараметрИдУзла", procid, "lisp", "datalisp", "316"));
