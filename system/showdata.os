...
Функция ПоказатьСтруктуруУзла(Узел, ЭтоАтрибут = Ложь) Экспорт
...
Функция ОтобразитьDOM(Вкладка, КодУзла, Знач ОбновитьУзел = Ложь, Знач ТипУзла = "", НачальныйУзел = Ложь)
	...
	Если ОбновитьУзел Тогда
		...
		Если Представление = "" Тогда
			Представление = ПоказатьСтруктуруУзла(Узел, (ТипУзла = "Атрибут"));
		КонецЕсли;
		...
		Если НЕ УзелАтрибут = Неопределено Тогда
			...
			Представление = СтрЗаменить(Представление, "<!--Атрибуты-->", Атрибуты);
		КонецЕсли;
		...
		Если УзелСостояние(Узел, "УзелОткрыт") = Истина  Тогда
			...
			Если НЕ УзелДочерний = Неопределено Тогда
				...
				Представление = СтрЗаменить(Представление, "<!--Дочерний-->", Дочерний);
			КонецЕсли;
		КонецЕсли;
