...
Функция ИсточникДанных(Данные, Параметры) Экспорт
	...
	Запрос = Новый Структура("taskid, Данные, Узел, ЗапросДанных, cmd", ТекущаяУниверсальнаяДатаВМиллисекундах(), Данные, Узел, ЗапросДанных, "ЗапросДанных");
...
Функция СписокДанных(Данные, Параметры) Экспорт
	...
	Индекс = Данные.Процесс.ВыполнитьЗапросКСерверуДанных("БазаДанных" + Символы.Таб + БазаДанных);
	Если НЕ Индекс = "" Тогда
