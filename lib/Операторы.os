...
Функция Оператор_ЕстьЗначение(Данные, Знач Аргумент) Экспорт
	...
	КонецЕсли;
	Значение = Данные.ПолучитьПредставление(Аргумент);
	Возврат (НЕ "" + Значение = "");
...
Функция Оператор_Пустой(Данные, Знач Аргумент) Экспорт
	Если Аргумент = Неопределено Тогда
		ВызватьИсключение "Ожидается аргумент";
	КонецЕсли;
	Аргумент = Данные.ПолучитьПредставление(Аргумент);
...
Функция Оператор_Сумма(Данные, Знач Аргумент) Экспорт
	...
	Пока Аргумент <> Неопределено Цикл
		Значение = Значение + Данные.ПолучитьПредставление(Аргумент);
		Аргумент = Аргумент.Соседний;
	КонецЦикла;
	Возврат Значение;
КонецФункции // Сумма()
...
Функция Оператор_Если(Данные, Знач Узел) Экспорт
	...
	зЕсли = Данные.ПолучитьПредставление(СписокЕсли);
	Если ТипЗнч(зЕсли) = Тип("Строка") Тогда
		зЕсли = (зЕсли = "Истина");
	КонецЕсли;
	Если зЕсли = Истина Тогда
		Возврат Данные.ПолучитьПредставление(СписокТогда)
	ИначеЕсли НЕ СписокИначе = Неопределено Тогда
		Возврат Данные.ПолучитьПредставление(СписокИначе)
	Иначе
...
Функция Оператор_Выбор(Данные, Знач Список) Экспорт
	...
	Пока СписокКогда <> Неопределено Цикл
		...
		КонецЕсли;
		Если Данные.ПолучитьПредставление(СписокКогда) = Истина Тогда
			Возврат Данные.ПолучитьПредставление(СписокТогда);
		КонецЕсли;
...
Функция Оператор_Равно(Данные, Знач Аргумент) Экспорт
	...
	Пока Аргумент <> Неопределено И Результат Цикл
		Результат = Результат И Значение = Данные.ПолучитьПредставление(Аргумент);
		Аргумент = Аргумент.Соседний;
	КонецЦикла;
	Возврат Результат;
КонецФункции // Равно()
...
Функция Оператор_Больше(Данные, Знач Аргумент) Экспорт
	...
	Если Аргумент = Неопределено Тогда
		ВызватьИсключение "Ожидается аргумент";
	КонецЕсли;
	Значение1 = Число(Данные.ПолучитьПредставление(Аргумент));
	Аргумент = Аргумент.Соседний;
	Если Аргумент = Неопределено Тогда
		ВызватьИсключение "Ожидается аргумент";
	КонецЕсли;
	Результат = Истина;
	Пока Аргумент <> Неопределено И Результат Цикл
		Значение2 = Число(Данные.ПолучитьПредставление(Аргумент));
...
Функция Оператор_НеРавно(Данные, Знач Аргумент) Экспорт
	...
	Если Аргумент = Неопределено Тогда
		ВызватьИсключение "Ожидается аргумент";
	КонецЕсли;
	Значение1 = Данные.ПолучитьПредставление(Аргумент);
	Аргумент = Аргумент.Соседний;
	Если Аргумент = Неопределено Тогда
		ВызватьИсключение "Ожидается аргумент";
	КонецЕсли;
	Результат = Истина;
	Пока Аргумент <> Неопределено И Результат Цикл
		Значение2 = Данные.ПолучитьПредставление(Аргумент);
		Результат = Результат И Значение1 <> Значение2;
		Значение1 = Значение2;
		Аргумент = Аргумент.Соседний;
	КонецЦикла;
...
Функция Оператор_ВывестиСообщение(Данные, Знач Аргумент) Экспорт
	...
	Пока Аргумент <> Неопределено Цикл
		Значения.Добавить(Данные.ПолучитьПредставление(Аргумент));
		Аргумент = Аргумент.Соседний;
	КонецЦикла;
...
Функция Оператор_ВСтуктуру(Данные, Знач Аргумент, Результат = Неопределено) Экспорт
	...
	Если НЕ Аргумент = Неопределено Тогда
		Если Аргумент.Имя = "Ключ" ИЛИ Аргумент.Имя = "К" Тогда
			...
			КонецЕсли;
		Иначе
			Возврат Данные.ПолучитьПредставление(Аргумент);
		КонецЕсли;
	КонецЕсли;
	Возврат Результат;
КонецФункции
