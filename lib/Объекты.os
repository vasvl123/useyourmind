...
Функция Кубик(Данные, Параметры) Экспорт
	...
	Если НЕ Параметры.Свойство("Свойства", парСвойства) Тогда
		узелСвойства = Данные.НовыйСоседний(Данные.Атрибут(ЭтотУзел), Новый Структура("Имя, Значение", "Свойства", ""));
		...
		Свойства = СтруктуруВСвойства(Данные, узелСвойства, стрСвойства);
		//парСвойства = Данные.Дочерний(узелСвойства);
		Данные.УзелСостояниеЗначение(ЭтотУзел, "Свойства", Свойства); // оптимизация
	Иначе
	...
	Результат = "<script>var p = {id: '" + ЭтотУзел.Код + "'";
