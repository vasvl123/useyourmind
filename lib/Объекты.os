...
КонецФункции // ОбработатьСвойства()
...
Функция СвойстваОбъекта(ТипОбъекта)
	...
	ИначеЕсли ТипОбъекта = "Выполнить" Тогда
		стрСвойства.Вставить("Условие", "");
		стрСвойства.Вставить("Выражение", "");
		стрСвойства.Вставить("Результат", "");
...
Функция ОбработатьОбъект(Данные, ЭтотУзел, ТипОбъекта, Атрибуты, структЗадача) Экспорт
	...
	Если Свойства = Неопределено Тогда
		Свойства = Данные.ПолучитьСвойства(УзелСвойства);
		узФорма = Неопределено;
		Если Свойства.Свойство("Форма", узФорма) Тогда
			Форма = Данные.ПолучитьСвойства(узФорма);
		КонецЕсли;
	КонецЕсли;

	ОбработатьСвойства(Данные, ЭтотУзел, ТипОбъекта, УзелСвойства, Свойства);
