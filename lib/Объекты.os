...
Функция ИсточникДанных_Модель(Данные, Свойства, Изменения) Экспорт
	...
	Если Инициализация Тогда
		Данные.НовыйДочерний(Свойства.д.ЗапросДанных, ИмяЗначение("ПоследняяПозиция"), Истина, Истина);
		...
		Если НЕ дУзел = Неопределено Тогда
			...
			Если НЕ Узел = Неопределено Тогда
				...
				Если Роль = "bck" Тогда
					...
					ИсточникДанных.Свойства.д.ЗапросДанных.д.НачальнаяПозиция.Значение = ИсточникДанных.Свойства.д.ЗапросДанных.д.ПоследняяПозиция.Значение;
				ИначеЕсли Роль = "fwd" Тогда
					Начало = Начало + Количество;
					ИсточникДанных.Свойства.д.ЗапросДанных.д.ПоследняяПозиция.Значение = ИсточникДанных.Свойства.д.ЗапросДанных.д.НачальнаяПозиция.Значение;
