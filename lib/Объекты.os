	...
	Если Изменения.Получить(Свойства.д.События) = Истина Тогда
		...
		Если НЕ дУзел = Неопределено Тогда
			...
			Если НЕ Узел = Неопределено Тогда
				...
				кПозиция = Число(Свойства.д.кПозиция.Значение);
				икПозиция = ИсточникДанных.Свойства.д.ЗапросДанных.д.КонечнаяПозиция.Значение;
				Если кПозиция = "0" ИЛИ Число(икПозиция) < Число(кПозиция) Тогда
					кПозиция = икПозиция;
				КонецЕсли;
				Если Роль = "bck" Тогда
					нПозиция = Число(Свойства.д.нПозиция.Значение);
					Начало = Число(Свойства.д.Начало.Значение);
					Количество = Число(Свойства.д.Количество.Значение);
					Данные.СоздатьСвойства(Свойства.д.Страницы, ПанельДанных_Кнопка(Начало, нПозиция), Истина, Ложь);
					ИсточникДанных.Свойства.д.ЗапросДанных.д.Направление.Значение = "Назад";
					...
					Свойства.д.нПозиция.Значение = "" + кПозиция;
				// ИначеЕсли Роль = "fwd" Тогда
				// 	Начало = Начало + Количество;
				// 	ИсточникДанных.Свойства.д.ЗапросДанных.д.Направление.Значение = "Вперед";
				// 	ИсточникДанных.Свойства.д.ЗапросДанных.д.НачальнаяПозиция.Значение = ИсточникДанных.Свойства.д.ЗапросДанных.д.КонечнаяПозиция.Значение;
				КонецЕсли;
				Свойства.д.кПозиция.Значение = кПозиция;
			КонецЕсли;
			ИсточникДанных.Изменения.Вставить(ИсточникДанных.Свойства.д.ЗапросДанных, Истина);
			Данные.ОбъектыОбновить.Вставить(ИсточникДанных, Истина);
		КонецЕсли;
		Данные.УдалитьУзел(дУзел, , Истина);
