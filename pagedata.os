...
Перем зСвойство, уСвойство;
	...
	Если НЕ зСвойство = Неопределено Тогда
		...
		Для каждого Свойство Из Свойства Цикл
			НовоеЗначениеУзла(Свойства.д.События, ИмяЗначение("Строка", Значение), Истина);
		КонецЦикла;
	КонецЕсли;
	...
	Для каждого стр Из стрСвойства Цикл // парсер
		Если НЕ стр = "" Тогда
			...
			Если Служебный = "Только" Тогда
				Если т = 0 И НЕ (Служ = Истина) Тогда
					Продолжить;
				КонецЕсли;
				Служ = Истина;
			КонецЕсли;
			...
			КонецЕсли;
			Если т > к Тогда
				св = НовыйДочерний(св, ИмяЗначение(Имя, "" + Зн), Служ, Служ = Истина);
				к = т;
			Иначе
				Пока т < к Цикл
					св = св.Родитель;
