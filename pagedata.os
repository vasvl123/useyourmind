...
Функция ПолучитьСвойствоОбъекта(Знач Узел, Путь)
	МассивПуть = СтрРазделить(Путь, " ");
...
Функция ПолучитьЗначениеСвойстваОбъекта(Знач Узел, ПолучитьСсылку = Ложь) Экспорт
	...
	Если Путь = "Содержимое" Тогда // это временное свойство
		Возврат "" + УзелСвойство(оУзел, "Содержимое");
	КонецЕсли;

	Узел = ПолучитьСвойствоОбъекта(оУзел, Путь);
...
Функция ОбработатьОбъект(Знач Узел, Конструктор = Ложь) Экспорт
	...
	Если НЕ Библиотека = Неопределено Тогда
		...
		Если НЕ Узел.Свойство("Содержимое") Тогда
			ОбъектыОбновить.Вставить(свУзел, Узел); // инициализация объекта
		КонецЕсли;
	...
	Если НЕ Свойства = Неопределено Тогда
		...
		Иначе
			Состояние = ЗначениеСвойства(УзелВид);
			Содержимое = "";
		КонецЕсли;
	...
	Пока НЕ СледУзел = Неопределено Цикл
		...
		ИначеЕсли Имя = "Ссылка" Тогда
			Если НЕ "" + Значение = "" Тогда // указан путь к свойству объекта
				Состояние = ПолучитьЗначениеСвойстваОбъекта(Узел, Истина);
			КонецЕсли;
		...
		ИначеЕсли Имя = "Значение" Тогда // значение свойства объекта
			Если НЕ "" + Значение = "" Тогда
				Состояние = ПолучитьЗначениеСвойстваОбъекта(Узел);
			КонецЕсли;
