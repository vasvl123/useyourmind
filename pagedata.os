...
Функция СохранитьДанные() Экспорт
	Для каждого элУзел Из Узлы Цикл
		...
		КонецЕсли;
	КонецЦикла;
	ПозицияДанных = Процесс.ВыполнитьЗапросКСерверуДанных("osdb" + Символы.Таб + БазаДанных + Символы.Таб + "data" + Символы.Таб + ИмяДанных + Символы.Таб + "datatype" + Символы.Таб + "3", Данные.ПолучитьТекст());
...
Функция ПриСозданииОбъекта(обПроцесс, знБазаДанных = "", знИмяДанных = "", знПозицияДанных = "")
	...
	Текст = Процесс.ВыполнитьЗапросКСерверуДанных("osdb" + Символы.Таб + БазаДанных + Символы.Таб + "data" + Символы.Таб + ИмяДанных + Символы.Таб + "dataposition" + Символы.Таб + ПозицияДанных);
