...
Функция КопироватьТело(Узел, Аргументы, ЭтоАтрибут = Ложь, ПервыйВызов = Ложь)
	...
	Если НЕ ЭтоАтрибут Тогда
		...
		Если НЕ УзелАтрибут = Неопределено Тогда
			УзелАтрибут = КопироватьТело(УзелАтрибут, Аргументы, Истина);
		...
		Если НЕ УзелДочерний = Неопределено Тогда
			УзелДочерний = КопироватьТело(УзелДочерний, Аргументы);
		...
		Иначе
			...
			Если НЕ УзелСоседний = Неопределено Тогда
				УзелСоседний = КопироватьТело(УзелСоседний, Аргументы);
...
Функция ТелоФункции(Объявление, Применение)
	...
	Возврат КопироватьТело(Дочерний(Объявление), Аргументы);
...
Функция ОбъектЗначение(Знач Узел)
	...
	Пока НЕ Узел = Неопределено Цикл
		Если (Узел.Имя = "Пусть" И Объявление = Неопределено) ИЛИ Узел.Имя = "Перем" Тогда
	...
	Если НЕ ЭтоФункция Тогда
		...
		КонецЕсли;
	КонецЕсли;
	Объявление.Дочерний = Значение.Код;
КонецФункции
		...
		Иначе
			...
			Если ЗначениеОбъекта = Неопределено Тогда
				...
				Если НЕ ОбъявлениеОбъекта = Неопределено Тогда
					...
					Иначе
						ЗначениеОбъекта = Дочерний(ОбъявлениеОбъекта);
					КонецЕсли;
