...
Функция ОпределениеФункции(Знач Окружение, Знач Узел)
...
Функция Переменная(Имя, Узел = Неопределено)
	Если Узел = Неопределено Тогда
		Возврат Переменные[Имя];
	Иначе
		Переменные[Имя] = Узел;
	КонецЕсли;
	Возврат Неопределено;
...
Функция Интерпретировать(Знач Окружение, Знач Узел) Экспорт
	...
	Если Имя = "Объект" Тогда
		//Сообщить(Значение);
		Если Значение = "Пусть" Тогда
			Возврат Пусть(Окружение, Дочерний(Узел));
		ИначеЕсли Значение = "Лямбда" Тогда
			Возврат Лямбда(Окружение, Дочерний(Узел));
		ИначеЕсли Значение = "Список" Тогда
			Возврат Узел("Список", Дочерний(Узел), Неопределено);
		ИначеЕсли Значение = "Пустой" Тогда
			Возврат Значение(Интерпретировать(Окружение, Дочерний(Узел))) = Неопределено;
		...
		Иначе
			...
			Если ТипЗнч(ЭлементОкружения) = Тип("Структура") Тогда
				Если ЭлементОкружения.Имя = "Лямбда" Тогда
					Возврат ЗначениеФункции(Окружение, ЭлементОкружения, Дочерний(Узел));
				ИначеЕсли ЭлементОкружения.Имя = "Список" Тогда
					Возврат ЭлементОкружения;
				Иначе
					ВызватьИсключение("Неизвестный объект" + Значение);
				КонецЕсли;
			Иначе
				Возврат ЭлементОкружения;
			КонецЕсли;
	...
	ИначеЕсли Имя = "Функция" Тогда
		Возврат ОпределениеФункции(Окружение, Узел);
	ИначеЕсли Имя = "Узел" Тогда
		Узел.Вставить("Окружение", Окружение);
		Возврат Дочерний(Узел);
	ИначеЕсли Имя = "Перем" Тогда
		Возврат Переменная(Узел.Значение, Дочерний(Узел));
	ИначеЕсли Имя = "Свойство" Тогда
		Возврат УзелСвойство(Интерпретировать(Окружение, Дочерний(Узел)), Узел.Значение);
	ИначеЕсли Имя = "Список" Тогда
		Возврат Интерпретировать(Окружение, Значение);
	ИначеЕсли Имя = "Лямбда" Тогда
		Лямбда = Лямбда(Окружение, Дочерний(Узел));
		Возврат ЗначениеФункции(Окружение, Лямбда, Соседний(Узел));
	Иначе
		ВызватьИсключение("Неизвестный объект " + Имя);
	КонецЕсли;
...
Функция Значение(Знач Узел)
	Если НЕ ТипЗнч(Узел) = Тип("Структура") Тогда
		ВызватьИсключение "Неверный узел";
	КонецЕсли;
	УзелЗначение = УзелСвойство(Узел, "Значение");
	Если НЕ "" + УзелЗначение = "" Тогда
		Возврат УзелЗначение;
	КонецЕсли;
	УзелДочерний = УзелСвойство(Узел, "Дочерний");
	Если НЕ УзелДочерний = Неопределено Тогда
		Возврат ПолучитьУзел(УзелДочерний);
	Иначе
		ВызватьИсключение "Неверное значение узла";
	КонецЕсли;
