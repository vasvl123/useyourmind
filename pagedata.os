...
Функция ВставитьУзел(Знач СтруктураУзла) Экспорт
	Если СтруктураУзла.Свойство("Код") Тогда
		Данные.ВставитьСтроку(СтруктураУзла.Код, СтруктуруВСтроку(СтруктураУзла));
	Иначе
		СтруктураУзла.Вставить("Код", "" + (Данные.КоличествоСтрок() + 1));
		Данные.ДобавитьСтроку(СтруктуруВСтроку(СтруктураУзла));
	КонецЕсли;
	Узлы.Вставить(СтруктураУзла.Код, СтруктураУзла);
	Возврат СтруктураУзла;
КонецФункции // ВставитьУзел(СтруктураУзла)

Функция УдалитьУзел(Узел, НачальныйУзел = Истина) Экспорт
	...
	Если НачальныйУзел Тогда
		...
		Если УзелСтарший.Свойство("Атрибут") Тогда
			...
			КонецЕсли;
		КонецЕсли;
		Если УзелСтарший.Свойство("Дочерний") Тогда
			...
			КонецЕсли;
		КонецЕсли;
		Если УзелСтарший.Свойство("Соседний") Тогда
...
Функция Старший(Знач Узел) Экспорт
	Если НЕ ТипЗнч(Узел) = Тип("Структура") Тогда
		ВызватьИсключение "Неверный узел";
	КонецЕсли;
	Если Узел.Свойство("Старший", Узел) Тогда
		Узел = ПолучитьУзел(Узел);
	КонецЕсли;
	Возврат Узел;
...
Функция Родитель(Знач Узел) Экспорт
	...
	Если Узел.Свойство("Родитель", УзелРодитель) Тогда
		Возврат ПолучитьУзел(УзелРодитель);
	КонецЕсли;
	УзелКод = Узел.Код;
	СтаршийУзел = Старший(Узел);
	Пока НЕ СтаршийУзел = Неопределено Цикл
		Если СтаршийУзел.Свойство("Дочерний") Тогда
...
Функция Атрибут(Знач Узел) Экспорт
	Если НЕ ТипЗнч(Узел) = Тип("Структура") Тогда
		ВызватьИсключение "Неверный узел";
	КонецЕсли;
	Если Узел.Свойство("Атрибут", Узел) Тогда
		Узел = ПолучитьУзел(Узел);
	КонецЕсли;
	Возврат Узел;
