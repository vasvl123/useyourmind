...
Функция СоздатьСвойства(Узел, шСвойства)
	...
	УзелСвойства = НовыйДочерний(Узел, Новый Структура("Имя, Значение", "Свойства", ""), Служебный);
	к = -1;
	св = УзелСвойства;
	...
	Для каждого стр Из стрСвойства Цикл // парсер
		Если НЕ стр = "" Тогда
			...
			КонецЕсли;
			Если т > к Тогда
				св = НовыйДочерний(св, Новый Структура("Имя, Значение", Имя, "" + Зн), Служебный);
				к = т;
			Иначе
				Пока т < к Цикл
					св = св.Родитель;
					к = к - 1;
				КонецЦикла;
				св = НовыйСоседний(св, Новый Структура("Имя, Значение", Имя, "" + Зн), Служебный);
			КонецЕсли;
			// атрибуты
			ат = св;
			Пока п < м.Количество() Цикл
				...
				КонецЕсли;
				Если ат = св Тогда
					ат = НовыйАтрибут(ат, Новый Структура("Имя, Значение", Имя, "" + Зн), Служебный);
				Иначе
					ат = НовыйСоседний(ат, Новый Структура("Имя, Значение", Имя, "" + Зн), Служебный);
				КонецЕсли;
				п = п + 1;
			КонецЦикла;
		КонецЕсли;
