...
Функция СохранитьДанные() Экспорт
	Для каждого элУзел Из Узлы Цикл
		...
		КонецЕсли;
	КонецЦикла;
	ПозицияДанных = Процесс.ПередатьДанныеНаСервер(Данные.ПолучитьТекст(), БазаДанных, ИмяДанных);
...
Функция ПриСозданииОбъекта(обПроцесс, знБазаДанных = "", знИмяДанных = "", знПозицияДанных = "")
	...
	Текст = Процесс.ПолучитьДанныеССервера(БазаДанных, ИмяДанных, ПозицияДанных);
