...
Функция УзелЗначение(Знач Узел) Экспорт
	...
	Если Узел.Имя = "О" ИЛИ Узел.Имя = "Объект" Тогда
		Расширение = "" + ВызватьФункцию(Узел, Узел.Значение);
...
Функция РасширениеУзла(Знач Узел)
	...
	Если Расширение = Неопределено Тогда
		...
		Если НЕ Атр = Неопределено Тогда
			...
			ИначеЕсли Атр.Имя = "Функция" ИЛИ Атр.Имя = "Ф" ИЛИ Атр.Имя = "Тип" ИЛИ Атр.Имя = "Т" Тогда // функцию потом убрать
...
Функция ДобавитьСвойство(Узел, стрСвойства) Экспорт
	парСвойства = Дочерний(Узел);
	Если НЕ парСвойства = Неопределено Тогда
		Если парСвойства.Имя = "Свойства" Тогда
			Свойства = УзелСостояние(парСвойства, "Свойства");
			Если НЕ Свойства = Неопределено Тогда
				...
				Иначе
					элСвойство = НовыйПоследний(Дочерний(парСвойства), стрСвойства, Истина);
...
Функция ДобавитьСобытие(Узел, стрСобытие) Экспорт
	Событие = УзелСвойство(Узел, "Событие");
	стрСобытие.Вставить("Предыдущее", Событие);
	Узел.Вставить("Событие", стрСобытие);
