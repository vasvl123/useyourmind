...
Функция УзелЗначение(Знач Узел, Обновлять = Истина, Пересчитать = Ложь) Экспорт
	...
	Если НЕ Узел = Неопределено Тогда
		...
		КонецЕсли;
		Состояние = УзелСостояние(Узел, "ЗначениеУзла"); // оптимизация
		Если Пересчитать = Истина ИЛИ Состояние = Неопределено Тогда
...
Функция Интерпретировать(Знач Узел, ЭтоАтрибут = Ложь, НачальныйУзел = Истина) Экспорт
	...
	ИначеЕсли Имя = "Значение" ИЛИ Имя = "З" Тогда
		Если НЕ "" + Значение = "" Тогда
			...
			СвойствоПересчитать = НайтиАтрибут(Узел, "Персчитать", "Да");
			Состояние = УзелЗначение(Узел, СвойствоОбновлять = Неопределено, СвойствоПересчитать = Неопределено);
		КонецЕсли;
