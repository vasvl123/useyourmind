...
Функция Интерпретировать(Знач Окружение, Знач Узел, Знач Применить = Истина, ЭтоАтрибут = Ложь, НачальныйУзел = Истина) Экспорт
	...
	ИначеЕсли Имя = "Пусть" Тогда
		ОбъектЗначение(Окружение, Значение, Интерпретировать(Окружение, Дочерний(Узел)));
	...
	ИначеЕсли Имя = "Первый" Тогда
		Список = Интерпретировать(Окружение, Дочерний(Узел));
	...
	ИначеЕсли Имя = "Список" Тогда
		Состояние = Интерпретировать(Окружение, Дочерний(Узел), , , Ложь);
