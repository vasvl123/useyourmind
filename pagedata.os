...
Функция ОбновитьУзел(Знач Узел, НачальныйУзел = Истина) Экспорт
	...
	Если НачальныйУзел И (Узел = Корень ИЛИ Узел.Имя = "Элемент" ИЛИ Узел.Имя = "Э") Тогда // потом убрать
	...
	Пока НЕ Узел = Неопределено Цикл
		Если Узел.Имя = "Узел" ИЛИ Узел.Имя = "У" Тогда
			Если УзелСостояние(Узел, "Показать") = Истина Тогда
	...
	// Если НЕ Состояние = Неопределено Тогда
		...
		Если НЕ Связи = Неопределено Тогда
			...
			Для каждого элУзел Из Связи Цикл
				...
				Если Узел.Имя = "Элемент" ИЛИ Узел.Имя = "Э" Тогда // потом убрать
					ОбновитьПредставлениеУзла(Узел);
					Продолжить;
				КонецЕсли;
...
Функция Интерпретировать(Знач Узел, ЭтоАтрибут = Ложь, НачальныйУзел = Истина) Экспорт
	...
	ИначеЕсли Имя = "Узел" ИЛИ Имя = "У" Тогда // объявление узла
		Если Узел = Корень Тогда
			Элемент = Истина; // потом убрать
		Иначе
			Элемент = УзелСостояние(Узел, "Показать");
		КонецЕсли;
		Если Элемент = Неопределено Тогда
			Элемент = НайтиАтрибут(Узел, "Показать", "Да"); // если нужно сразу показать
			Если Элемент = Неопределено Тогда
				Элемент = Ложь;
			Иначе
				Элемент = Истина;
	...
	ИначеЕсли Имя = "Значение" ИЛИ Имя = "З" Тогда
		...
		КонецЕсли;
	ИначеЕсли Имя = "Элемент" ИЛИ Имя = "Э" Тогда // потом убрать
