...
Функция ВставитьЗначение(Знач Узел) Экспорт
	НачальныйУзел = Узел;
	Узел = ОпределениеУзла(Узел, Узел.Значение);
	Если Узел = Неопределено Тогда
		Возврат Неопределено;
	КонецЕсли;
	Значение = Дочерний(НачальныйУзел);
...
Функция Интерпретировать(Знач Узел, ЭтоАтрибут = Ложь, НачальныйУзел = Истина) Экспорт
	...
	ИначеЕсли Имя = "Вставить" ИЛИ Имя = "Пусть" ИЛИ Имя = "П" Тогда // потом убрать
		...
		// 	УзелУстановитьЗначение(Определение, Элемент);
		// КонецЕсли;
