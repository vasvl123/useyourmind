...
Функция ОбновитьУзел(Знач Узел, НачальныйУзел = Истина) Экспорт
	...
	Если Узел.Имя = "Узел" ИЛИ Узел.Имя = "У" Тогда
		Если УзелСостояние(Узел, "Элемент") = Истина Тогда
...
Функция Интерпретировать(Знач Узел, ЭтоАтрибут = Ложь, НачальныйУзел = Истина) Экспорт
	...
	ИначеЕсли Имя = "Узел" ИЛИ Имя = "У" Тогда // объявление узла
		...
		Иначе
			Элемент = УзелСостояние(Узел, "Элемент");
		КонецЕсли;
		Если Элемент = Неопределено Тогда
			Элемент = НайтиАтрибут(Узел, "Элемент", "Да"); // если нужно сразу показать
			Если Элемент = Неопределено Тогда
				Элемент = Ложь;
			Иначе
				Элемент = Истина;
			КонецЕсли;
			УзелСостояниеЗначение(Узел, "Элемент", Элемент);
		КонецЕсли;
