...
Функция КопироватьВетку(Узел, Аргументы = Неопределено, ЭтоАтрибут = Ложь, ПервыйВызов = Истина, Служебный = Истина)
	...
	КопияУзел = НовыйУзел(Новый Структура("Имя, Значение", ИмяУзла, ЗначениеУзла), Служебный);

	Если НЕ ЭтоАтрибут Тогда

		УзелАтрибут = Атрибут(Узел);
		Если НЕ УзелАтрибут = Неопределено Тогда
			УзелАтрибут = КопироватьВетку(УзелАтрибут, Аргументы, Истина, Ложь, Служебный);
		...
		Если НЕ УзелДочерний = Неопределено Тогда
			УзелДочерний = КопироватьВетку(УзелДочерний, Аргументы, , Ложь, Служебный);
	...
	Иначе
		...
		Если НЕ УзелСоседний = Неопределено Тогда
			УзелСоседний = КопироватьВетку(УзелСоседний, Аргументы, ЭтоАтрибут, Ложь, Служебный);
...
Функция ВставитьУзел(Буфер, КодУзла, ЭтоАтрибут = Ложь, ПервыйВызов = Истина, Служебный = Ложь) Экспорт
	...
	Узел = КопироватьВетку(Буфер.Получить(КодУзла), , , , Служебный);
