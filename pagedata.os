...
Функция УзелЗначение(Знач Узел, ИмяУзла = Неопределено) Экспорт

	Состояние = Неопределено;
	Если ИмяУзла = Неопределено Тогда
		ИмяУзла = Узел.Значение;
	КонецЕсли;
	...
	Пока НЕ Узел = Неопределено Цикл
		...
		Иначе
			...
			Если НЕ Узел = АтрибутРодитель И (Узел.Имя = "Копия" ИЛИ Узел.Имя = "К" ИЛИ Узел.Имя = "Функция" ИЛИ Узел.Имя = "Ф") Тогда
				...
				КонецЦикла;
			КонецЕсли;
			Если Узел.Имя = "Узел" ИЛИ Узел.Имя = "У"
				ИЛИ Узел.Имя = "Ссылка" ИЛИ Узел.Имя = "С" Тогда
				...
				Если НЕ Библиотека = Неопределено Тогда
					...
					Для каждого Метод Из ТаблицаМетодов Цикл
						...
						Пока НЕ Аргумент = Неопределено Цикл
							Аргументы.Вставить(Аргумент.Значение, Дочерний(Аргумент));
