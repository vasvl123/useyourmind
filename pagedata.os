...
Функция ФормаВид(Узел, Свойства)
...
Функция ОбработатьОбъект(Знач Узел, структЗадача = Неопределено) Экспорт
	...
	Если НЕ Библиотека = Неопределено Тогда
		...
		Состояние = Библиотека.ОбработатьОбъект(ЭтотОбъект, Узел, ТипОбъекта, Атрибуты, структЗадача);
		...
		Если НЕ Свойства = Неопределено Тогда
			...
			Иначе
				...
				Если НЕ Форма = Неопределено Тогда
			 		Состояние = ФормаВид(Узел, Свойства) + Содержимое;
				Иначе
