...
Функция ЗначениеСвойства(Свойства, Имя) Экспорт
	УзелСвойство = УзелСвойство(Свойства, Имя);
	Если НЕ УзелСвойство = Неопределено Тогда
		Возврат УзелСвойство.Значение;
	КонецЕсли;
...
Функция ПолучитьСвойства(УзелСвойства) Экспорт
	...
	Если Свойства = Неопределено Тогда
		...
		Если УзелСвойства.Родитель.Имя = "О" ИЛИ УзелСвойства.Родитель.Имя = "Объект" Тогда
			ОбъектыОбновить.Вставить(УзелСвойства.Родитель, УзелСвойства.Родитель); // инициализация объекта
		КонецЕсли;
	КонецЕсли;
	Возврат Свойства;
...
Функция НайтиСвойствоОбъекта(Знач Узел, Путь)
	...
	Если НЕ Узел = Неопределено Тогда
		...
		Пока к < МассивСвойства.Количество() Цикл
			...
			Свойства = ПолучитьСвойства(Дочерний(Свойство));
			Свойство = УзелСвойство(Свойства, ИмяСвойства);
