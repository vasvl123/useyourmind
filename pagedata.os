...
Функция ОбъявлениеОбъекта(Знач Узел, Знач ИмяЭлемента) Экспорт
	...
	// Поиск объявления объекта
	Пока НЕ Узел = Неопределено Цикл
		Если Узел.Имя = "Пусть" ИЛИ Узел.Имя = "Перем" ИЛИ "Функция" Тогда
		...
		Иначе
			...
			Если ЗначениеОбъекта = Неопределено Тогда
				...
				Если НЕ ОбъявлениеОбъекта = Неопределено Тогда
					Если ОбъявлениеОбъекта.Имя = "Функция" ИЛИ ОбъявлениеОбъекта.Имя = "Лямбда" Тогда
						ЗначениеОбъекта = ЗначениеФункции(ОбъявлениеОбъекта, Узел);
					КонецЕсли;
				КонецЕсли;
			КонецЕсли;
