...
Функция КопироватьВетку(Узел, Аргументы = Неопределено, ЭтоАтрибут = Ложь, ПервыйВызов = Истина, Служебный = Истина)
	...
	Если НЕ ЭтоАтрибут Тогда
		...
		Если НЕ УзелАтрибут = Неопределено Тогда
			...
			УзелАтрибут.Вставить("Старший", КопияУзел);
		...
		Если НЕ УзелДочерний = Неопределено Тогда
			...
			УзелДочерний.Вставить("Старший", КопияУзел);
	...
	Иначе
		...
		Если НЕ УзелСоседний = Неопределено Тогда
			...
			УзелСоседний.Вставить("Старший", КопияУзел);
...
Функция ПолучитьУзел(Код, Старший = Неопределено) Экспорт
	...
	Если НЕ Старший = Неопределено Тогда
		...
		Если Старший.Дочерний = Код Тогда
			Узел.Родитель = Старший.Код;
		ИначеЕсли Старший.Соседний = Код Тогда
			Узел.Родитель = Старший.Родитель;
		КонецЕсли;
	КонецЕсли;
